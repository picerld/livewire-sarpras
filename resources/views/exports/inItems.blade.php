...
<body>
    ...
    <table class="table">
        ...
        <tbody>
            @foreach ($inItems as $index => $inItem)
                <tr>
                    <td style="font-size: 13px; text-align: center">{{ $index + 1 }}</td>
                    <td style="font-size: 13px; text-align: center">{{ $inItem->item->name }}</td>
                    <td style="font-size: 13px; text-align: center">{{ $inItem->qty }} {{ $inItem->item->unit }}</td>
                    <td style="font-size: 13px; text-align: center">{{ $inItem->created_at->format('d F Y') }}</td>
                    <td></td>
                </tr>
            @endforeach
        </tbody>
