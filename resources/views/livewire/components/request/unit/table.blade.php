<div class="flex flex-wrap gap-5 mx-16 lg:flex-nowrap md:flex-nowrap">
    <div class="w-full md:w-3/4 lg:w-3/4">
        <x-card>
            <x-header wire:model.live.debounce="search" title="My Requests" class="px-3 pt-3" size="text-3xl"
                ...
                <x-slot:actions>
                    ...
                    <x-button icon-right="m-plus" label="Add" wire:click="createRequestModal"
                        class="text-white bg-dark dark:bg-slate-100 hover:bg-dark hover:opacity-90 dark:text-black"
                        responsive aria-label="create submission" />
                </x-slot:actions>
            </x-header>
            ...
            <x-modal wire:model="createRequest" class="backdrop-blur"
