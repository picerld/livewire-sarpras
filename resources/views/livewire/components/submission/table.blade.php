<x-card>
    <x-header wire:model.live.debounce="search" title="Pengadaan" class="px-3 pt-3" size="text-3xl"
        ...
        <x-slot:actions>
            ...
            <x-dropdown label="Export" class="text-white btn-outline bg-dark hover:opacity-90">
                ...
                <x-menu-item title="Export Pdf" icon="o-arrow-up-on-square-stack" wire:click="submissionPdfModal" />
            </x-dropdown>
    ...
    <x-modal wire:model="submissionExportPdf" class="backdrop-blur modal-bottom lg:modal-middle md:modal-middle"
        ...
        <div class="flex flex-col gap-3">
            ...
            <form action="{{ route('submissions.export') }}" method="POST" target="_blank">
                @csrf
                ...
                <div class="flex flex-col gap-2 my-1">
                    ...
                    <label class="w-full form-control">
                        <div class="label">
                            <span class="text-sm font-semibold">Status Pengajuan</span>
                        </div>
