<div>
    ...
    <div id="stats" class="grid grid-cols-1 gap-6 mt-7 lg:grid-cols-4 md:grid-cols-2">
        ...
        <livewire:utils.stats title="Pengajuan" model="Pengajuan" icon="o-arrow-trending-up" description="Pengajuan model" />
        <livewire:utils.stats title="Permintaan" model="Permintaan" icon="o-arrow-trending-down"
