...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <nav class="px-10 navbar bg-base-100">
        <div class="navbar-start">
            ...
            <div class="flex pb-4">
                ...
                <h4 class="text-xl font-bold text-black dark:text-slate-200">Sarpras</h4>
            </div>
        </div>
    ...
    <main>
        <div class="flex flex-col items-center w-full h-screen gap-3 p-10">
            <div class="w-full">
